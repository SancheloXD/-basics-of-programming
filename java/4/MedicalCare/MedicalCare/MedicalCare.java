package MedicalCare;
/*
 * Вариант: 13. Номер зачетной книжки: 21-670.
 *
...
public class MedicalCare {
    ...
    public MedicalCare(String name, String adress, String FIO, String polis, String date, String vrach, String dolznost, String diagnoz) {
        this.name = name;
        this.adress = adress;
        this.FIO = FIO;
        this.polis = polis;
